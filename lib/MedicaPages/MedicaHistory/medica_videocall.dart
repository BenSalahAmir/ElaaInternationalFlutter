...
class MedicaVideocall extends StatefulWidget {
  const MedicaVideocall({Key? key}) : super(key: key);

  @override
  State<MedicaVideocall> createState() => _MedicaVideocallState();
}

class _MedicaVideocallState extends State<MedicaVideocall> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
              ...
              PopupMenuItem(
                ...
                child: Row(
                  children: [
                    ...
                    Text("Download_Video".tr, style: urbanistSemiBold.copyWith(fontSize: 14)),
                  ],
                ),
              ),
              PopupMenuItem(
                ...
                child: Row(
                  children: [
                    ...
                    Text("Delete_Video".tr, style: urbanistSemiBold.copyWith(fontSize: 14,color: Medicacolor.red)),
                  ],
                ),
              ),
            ],
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Dr.Maria Foose",style: urbanistBold.copyWith(fontSize: 18)),
                      ...
                      const CircleAvatar(
                        ...
                        child:Icon(Icons.videocam,size: 20,color: Medicacolor.primary,),
                      )
                    ],
                  ),
                ),
              ...
              SizedBox(height: height/66,),
              Text("30 minutes of video calls have been recored",style: urbanistMedium.copyWith(fontSize: 16)),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("Play_Video_Recordings".tr,style: urbanistBold.copyWith(fontSize: 16,color: Medicacolor.white),),
                  ],
                ),
              ),
              SizedBox(height: height/36,),
